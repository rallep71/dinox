...
### Q1/Q2 2026: The Windows Port

**Goal:** Make DinoX available as a first-class citizen on Windows (10/11).

- **Porting**: Use MSYS2/Mingw-w64 environment.
- **Dependencies**: Handle libcanberra, libsecret, and D-Bus exclusions.
- **Installer**: Create MSI or EXE installer (WiX or NSIS).
- **CI**: Automated Windows builds alongside Linux.

See [DEVELOPMENT_PLAN_WINDOWS.md](DEVELOPMENT_PLAN_WINDOWS.md) for technical details.

### Late 2026: OMEMO 2 (urn:xmpp:omemo:2)

- **Compatibility**: Dual-stack implementation (Legacy + Modern OMEMO).
- **Security**: Improved ciphers and forward secrecy.
